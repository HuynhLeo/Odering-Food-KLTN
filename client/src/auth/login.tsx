    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <form onSubmit={loginSubmitHandler} className="md:p-8 w-full max-w-md md:border border-gray-200 rounded-lg">
                <div className="mb-4">
                    <h1 className="font-bold text-2xl">LeoShop</h1>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-10">
                    {
                        loading ? <Button disabled className="w-full bg-orange hover:bg-hoverOrange"><Loader2 className="mr-4 h-4 w-4 animate-spin" />Vui lòng đợi</Button> : (
                            <Button type="submit" className="bg-orange w-full hover:bg-hoverOrange">Đăng nhập</Button>
                        )
                    }
                    <div className="mt-4">
